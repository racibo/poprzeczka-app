...
translations = {
    'pl': {
        ...
        # --- MENU HEADER ---
        'nav_header': "📋 Menu",
        'nav_editions_expander': "📋 Edycje i Rankingi",
        'nav_static_header': "📚 Informacje",
        
        # --- MENU EDYCJI (Dynamiczne) ---
        'nav_edition_upcoming': "⏳ {0}",
        'nav_edition_active': "🟢 {0}",
        'nav_edition_finalization': "🚩 {0}",
        'nav_edition_finished': "🏁 {0}",
        
        'nav_edition_ranking_active': "📊 Ranking {0}",
        'nav_edition_form_active': "📝 Formularz {0}",
        'nav_edition_ranking_finished': "🏁 Ranking {0}",
        'nav_edition_form_finished': "🔒 Formularz {0}",
        'nav_edition_ranking_upcoming': "⏳ {0}",
        ...
        # --- CTA (Zachęta do wprowadzania danych) ---
        'cta_header': "🤝 Pomóż uzupełnić dane!",
        'cta_description': "Widzisz braki w rankingu? Możesz samodzielnie dodać wyniki swoje lub innych uczestników. To proste!",
        'cta_button_pl': "📝 Wypełnij Formularz (PL)",
        'cta_button_en': "📝 Fill Form (EN)",
        ...
        **💰 Zasady Nagradzania (Beneficjenci):**
        ...
        'stats_rabbits_title': "🐰 Największy spryciarze",
        ...
        'form_error_edition_upcoming': "Formularz dla tej edycji nie jest jeszcze dostępny.",
        ...
        'form_upload_label': "Opcjonalny Zrzut Ekranu (załącz plik .png lub .jpg)",
        'form_thanks_note': "Dziękujemy za pomoc!",
        'form_ranking_info': "Sprawdź ranking w menu bocznym.",
        'form_error_message': "Błąd zapisu: {0}",
        'form_converters_error': "Błąd konwertera",
        
        # --- STATYSTYKI (POMOCNICY) ---
        'current_stats_top_submitters': "🏅 Najwięksi Pomocnicy",
        'current_stats_top_submitters_desc': "Kto pomagał w uzupełnianiu danych.",
        'current_stats_top_submitters_none': "Brak wpisów.",
        'current_stats_top_submitters_percentage': "Pomoc: **{0:.0f}%** ({1} wpisów). Admin: {2}.",
        
        # --- TABELA POMOCNIKÓW (NAGRODY) ---
        'helpers_info_text': "Zasady wyliczania nagród znajdziesz w zakładce 'Zasady' w menu po lewej stronie. Co tydzień następuje zmiana. Poniższa tabela pokazuje stan obecny:",
        ...
        'survival_analysis_desc': "Wykres pokazuje, ilu uczestników pozostało w grze każdego dnia. Uczestnik odpada 3 dni po ostatnim zaliczonym etapie (np. wynik 10 oznacza odpädnięcie 13. dnia).",
    ...
    'en': {
        ...
        'nav_edition_ranking_active': "📊 Ranking {0}",
        'nav_edition_form_active': "📝 Form {0}",
        'nav_edition_ranking_finished': "🏁 Ranking {0}",
        'nav_edition_form_finished': "🔒 Form {0}",
        'nav_edition_ranking_upcoming': "⏳ {0}",
        ...
        **💰 Reward Rules (Beneficiaries):**
        ...
        'stage_analysis_hardest': "📥 Hardest: **Day {0}** (Failed {1:.1f}%)",
        ...
        # --- FORM (ADDITIONAL) ---
        'form_converters_expander': "ℹ️ Converters (Strava/Bike/Other)",
        ...
        'form_upload_link_text': "📂 Screenshots Folder",
        'form_upload_label': "Optional Screenshot (attach .png or .jpg file)",
        'pl': "Opcjonalny Zrzut Ekranu (załącz plik .png lub .jpg)",
        ...
        # --- STATS (HELPERS) ---
        'current_stats_top_submitters': "🏅 Top Helpers",
        ...
        # --- DRAFT GENERATOR ---
        'draft_header': "📝 Post Draft Generator (For {0})",
        ...
        'draft_pb_congrats': "Attention! {0} {1} personal record ({2})! Congratulations 🏆",
